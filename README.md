...
2. 在创建的有状态的State的class中，重写initState()方法。并在里面注册你的flutter_boost路由，并实现路由跳转方法等。
...
3. 使用原生项目混合flutter的官方的混合方式即可，使用源码混合方式，修改podfile如下：可以很轻松的引入Flutter相应的framework
...
iOS开发组 > flutter-boost 和 fish-redux > 截屏2020-04-27 下午2.50.48.png
模板创建出来最简单的模块如下：
action.dart
effect.dart
page.dart
